...
import "../styles/AboutMe.css"; // If you have custom styles, otherwise you can remove this line.

const AboutMe = () => {
  return (
    <div className="bg-gradient-to-b from-blue-100 to-white min-h-screen py-10">
